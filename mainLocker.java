...
public class mainLocker {
    ...
    {
        Locker MM = new Locker(100, "Micky Mouse", 3, new
                CombinationLock(28, 17,39, 0));
        Locker DD = new Locker(275, "Donald Duck", 2, new
                CombinationLock(35, 16,27, 0));

        MM.openLocker();
        MM.putBookInLocker();
        MM.putBookInLocker();
        MM.putBookInLocker();
        DD.removeBookFromLocker();
